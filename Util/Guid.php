...
class Guid {
     ...
     * @return string
     */
    public static function get(string $prefix = null){
     ...
     * @return string
     */
    public static function create_guid_md5(string $prefix = null){
     ...
     * @return string
     */
    public static function create_guid_sha256(string $prefix = null){
        // mt_rand() 马特赛特旋转演算法，可以快速产生高质量的伪随机数，修正了古老随机数产生算法的很多缺陷
